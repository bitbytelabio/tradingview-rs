...
pub fn merge_quotes(quote_old: &QuoteValue, quote_new: &QuoteValue) -> QuoteValue {
    QuoteValue {
        ...
        currency: quote_new.currency.clone().or(quote_old.currency),
        symbol: quote_new.symbol.clone().or(quote_old.symbol),
        exchange: quote_new.exchange.clone().or(quote_old.exchange),
        market_type: quote_new.market_type.clone().or(quote_old.market_type),
    }
}
